...
- ((64760ab2-3fe6-4586-802b-fbf77162f98d)) 最大似然估计
  ...
  Introduction and problems [[card]]
	...
	- 推导过程
		...
		- 先无视$x_1$ 直接按照 $x_2 \ldots x_N$ 拆分, 拆分结束后,再把$x_1$ 直接加上去
	- Problems of MLE
	  id:: 6478b22a-97ba-45d9-8280-5faf76a70efe
	...
	- From counts to probabilities
		- ((64762b81-265e-4037-9f4c-352dee52300e))
		  ...
		  How to calculate  $P(monkeys)$ [[card]]
			...
			- For example $P(monkeys | arctic) = \dfrac{monkeys\ bigram\ counts}{arctic\ unigram\ counts}=0.1$
