	...
	- ((63d5a5bb-6f95-4066-aed1-44ad7891c364)), 双方在 [[Copyright, Designs and Patents Act]] 下的责任 [[card]]
	  ...
	  card-last-score:: 1
		...
		- 程序的 substantial part 实质性部分
			- ((63d52842-cea3-444a-ad14-35a17223f1cb))
			- Even if a very small part of the program is copied, it is a fringement if that part is important
			- it is an infringement if that part is a Standard function
