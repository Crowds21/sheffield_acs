...
- ((64073fe6-0f5a-4952-8a4a-4b70f50c1fea)) 条件随机场 CRF
  ref:: [从隐马尔科夫到条件随机场 | MaxMa Blog (anxiang1836.github.io)](https://anxiang1836.github.io/2019/11/05/NLP_From_HMM_to_CRF/)
	...
	- Introduction
		- Formula of CRF[[card]]
			- $\underset{\mathbf{y} \in \mathcal{Y}^{\mathcal{N}}}{\arg \max } P_{C R F}(\mathbf{y} \mid \mathbf{x} ; \mathbf{w})=\underset{\mathbf{y} \in \mathcal{Y}^{\mathcal{N}}}{\arg \max } \sum_{n=1}^N \mathbf{w} \cdot \phi\left(y_n, y_{n-1}, \mathbf{x}_n, n\right)$
	...
	- ((64074195-6461-4bbf-8d0c-9fd327b1794e)) [[card]]
		- ((6480d90a-07be-4dae-a571-1fc45334d0ca))
